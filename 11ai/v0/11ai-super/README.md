...
Six long-running skills that synchronize a clean repository, perform a project task repeatedly, verify the result, and stop when material issues are resolved or clearly documented.
...
The skills preserve unrelated work and do not commit or push unless the user explicitly requests it. `11ai-super-creator` applies the shared workflow to a user-specified task, `11ai-super-readme` is documentation-only, and the specialist super skills update the project areas named in their playbooks.
