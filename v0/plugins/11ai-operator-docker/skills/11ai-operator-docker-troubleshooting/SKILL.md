---
name: 11ai-operator-docker-troubleshooting
...
Conclude with the failing boundary, evidence, root cause or remaining uncertainty, exact fix applied or proposed, and verification result. If Docker itself is not healthy, hand off to `11ai-operator-docker-environment` before diagnosing application behavior.
