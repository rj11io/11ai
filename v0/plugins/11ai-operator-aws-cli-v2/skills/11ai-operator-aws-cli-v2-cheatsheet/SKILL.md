---
name: 11ai-operator-aws-cli-v2-cheatsheet
...
5. If the user supplies an error rather than a lookup question, hand off to `11ai-operator-aws-cli-v2-troubleshooting` and preserve the exact error code and request ID.
