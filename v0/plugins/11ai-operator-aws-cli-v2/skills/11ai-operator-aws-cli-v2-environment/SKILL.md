---
name: 11ai-operator-aws-cli-v2-environment
...
- **Access denied:** preserve the service, action, resource, region, and caller ARN. Hand off to `11ai-operator-aws-cli-v2-iam` for evidence-based permission analysis.
