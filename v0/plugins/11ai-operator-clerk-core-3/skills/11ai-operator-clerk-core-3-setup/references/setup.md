...
The server check is the access control. `Show` decides what renders; it does not stop a request. A page that fetches private data above a `Show` boundary fetches it for everyone.
