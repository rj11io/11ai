...
5. Keep the mirror current with webhook events **and** a scheduled reconciliation, because events get missed. See `11ai-workos-webhooks` and `11ai-workos-directory-sync`.
