---
name: 11ai-operator-antdesign-troubleshooting
...
When the evidence points to a broad setup problem, use `11ai-operator-antdesign-setup`; when it points to a visual system inconsistency, use `11ai-operator-antdesign-theming`.
