---
name: 11ai-operator-antdesign-layout
...
- If visual rules are inconsistent across pages, use `11ai-operator-antdesign-theming` rather than adding local overrides.
