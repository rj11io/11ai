...
| [`11ai-core-www-styleguides`](./skills/11ai-core-www-styleguides/SKILL.md) | Theming a Next.js and shadcn application with the house web design language: user tokens and fonts kept, missing pieces derived as balanced equivalents with contrast gates, bundled defaults otherwise |
