---
name: 11ai-operator-aws-environment
...
- **Access denied:** preserve the service, action, resource, region, and caller ARN. Hand off to `11ai-operator-aws-iam` for evidence-based permission analysis.
