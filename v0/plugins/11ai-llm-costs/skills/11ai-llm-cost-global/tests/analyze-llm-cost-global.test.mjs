...
try {
  ...
  assert.match(markdown, /\| Workspace \| Threads \| Tokens \| Known cost \| Wall time \| Active time \| Cost \/ wall hour \| Cost \/ active hour \|/)
  assert.match(markdown, /\| Thread \| Source \| Workspace \| Provider \/ model \/ effort \| Attributed at \| Tokens \| Selected cost \| Harness reported \| Method \| Wall time \| Active time \| Cost \/ wall hour \| Cost \/ active hour \|/)
