...
try {
  ...
  writeJsonl(join(codexHome, "sessions", "selected.jsonl"), [
    ...
    { timestamp: "2026-07-19T10:02:00.000Z", type: "turn_context", payload: { model: "gpt-5.6-sol", effort: "xhigh" } },
  ...
  assert.match(markdown, /\| openai \/ gpt-5\.6-sol \| xhigh \| 1 \| 1,100 \|/)
  ...
  assert.match(markdown, /\| Thread \| Relationship \| Parent thread \| Source \| Provider \/ model \/ effort \| Tokens \| Selected cost \| Harness reported \| Method \| Wall time \| Active time \| Cost \/ wall hour \| Cost \/ active hour \|/)
