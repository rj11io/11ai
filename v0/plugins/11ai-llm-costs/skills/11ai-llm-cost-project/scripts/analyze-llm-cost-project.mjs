...
if (argv.includes("--help")) {
  console.log("usage: node analyze-llm-cost-project.mjs [root-folder] [--output report.md] [--codex-home dir] [--claude-home dir] [--gemini-home dir] [--cline-tasks dir] [--roo-tasks dir] [--opencode-db file] [--thread id-or-source] [--project-only]")
  process.exit(0)
}
