...
Report exactly what is staged and what remains unstaged or untracked. Stop before committing; use `11ai-operator-git-commit` only when the user separately asks to commit.
