---
name: 11ai-supabase-environment
...
If the stack is not running, say so rather than starting it. Starting Docker containers is a state change belonging to `11ai-supabase-setup`.
