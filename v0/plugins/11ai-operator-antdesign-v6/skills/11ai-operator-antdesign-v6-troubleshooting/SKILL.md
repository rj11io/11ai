---
name: 11ai-operator-antdesign-v6-troubleshooting
...
When the evidence points to a broad setup problem, use `11ai-operator-antdesign-v6-setup`; when it points to a visual system inconsistency, use `11ai-operator-antdesign-v6-theming`.
