---
name: 11ai-operator-antdesign-v6-layout
...
- If visual rules are inconsistent across pages, use `11ai-operator-antdesign-v6-theming` rather than adding local overrides.
