...
| [`11ai-operator-convex-actions`](./skills/11ai-operator-convex-actions/SKILL.md) | Calling external services, scheduling work, crons, and inbound HTTP endpoints |
| [`11ai-operator-convex-auth`](./skills/11ai-operator-convex-auth/SKILL.md) | Wiring an identity provider and enforcing per-document access inside functions |
| [`11ai-operator-convex-file-storage`](./skills/11ai-operator-convex-file-storage/SKILL.md) | Uploading, serving, authorizing, and deleting files, and sweeping orphans |
| [`11ai-operator-convex-deployments`](./skills/11ai-operator-convex-deployments/SKILL.md) | Deploying to production, deploy keys, previews, data export and import, and rollback |
| [`11ai-operator-convex-integrations`](./skills/11ai-operator-convex-integrations/SKILL.md) | Wiring React and Next.js clients, identity providers, outbound services, webhooks, and mirrors |
| [`11ai-operator-convex-troubleshooting`](./skills/11ai-operator-convex-troubleshooting/SKILL.md) | Diagnosing a missing generated API, stuck queries, null identity, read limits, and post-deploy failures |
