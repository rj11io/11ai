...
`v0/plugins/11ai-TOOL-operations/.claude-plugin/plugin.json`

```json
{
  "$schema": "https://json.schemastore.org/claude-code-plugin-manifest.json",
  "name": "11ai-TOOL-operations",
...
`v0/plugins/11ai-TOOL-operations/.codex-plugin/plugin.json`
...
```json
{
  ...
  "skills": "./skills/",
  "interface": {
    "displayName": "11ai TOOL Operations",
    ...
    "capabilities": [],
    "defaultPrompt": "Help me use the 11ai-TOOL-operations skills for this TOOL task."
  }
}
```
...
{
  "name": "11ai-TOOL-operations",
  "source": "./v0/plugins/11ai-TOOL-operations"
}
```

## 4. Plugin README

`v0/plugins/11ai-TOOL-operations/README.md` — every skill name must appear somewhere in this file. Use the template in [plugin-blueprint.md](plugin-blueprint.md).
...
```text
| [TOOL operations](./v0/plugins/11ai-TOOL-operations/README.md) | 10 | Short summary of what the plugin covers |
```

A layout entry in the indented tree block, with the same count:

```text
    11ai-TOOL-operations/     10 TOOL operation skills under skills/
```
