...
Use `11ai-stripe-environment` for the full inspection. If a client and webhook route already exist, this is not a fresh setup — change only what is missing.
