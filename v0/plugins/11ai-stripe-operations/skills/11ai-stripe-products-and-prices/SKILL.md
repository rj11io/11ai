---
name: 11ai-stripe-products-and-prices
...
3. **Decide about existing subscribers.** Two honest options:
   ...
   - **Migrate them.** Update each subscription's item to the new price, with a chosen proration behaviour, after telling them. See `11ai-stripe-subscriptions`.
