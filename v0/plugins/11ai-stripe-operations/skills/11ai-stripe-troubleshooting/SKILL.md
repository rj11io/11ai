---
name: 11ai-stripe-troubleshooting
...
Hand off when the cause is elsewhere: `11ai-stripe-environment` for mode and key questions, `11ai-stripe-setup` if wiring is missing, `11ai-stripe-webhooks` for delivery and verification, `11ai-stripe-subscriptions` for status and proration, `11ai-stripe-payments` for charges and refunds, `11ai-stripe-customers` for duplicates and links, and `11ai-stripe-integrations` for the mirror and entitlements.
