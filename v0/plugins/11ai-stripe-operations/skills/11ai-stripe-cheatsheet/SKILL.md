...
Lead with the call. Add one line on what it changes, whether it moves money or is irreversible, and whether it is test or live mode. Name the operation skill when the task goes beyond a lookup: pricing to `11ai-stripe-products-and-prices`, Checkout to `11ai-stripe-checkout`, plan changes to `11ai-stripe-subscriptions`, charges and refunds to `11ai-stripe-payments`, events to `11ai-stripe-webhooks`, and failures to `11ai-stripe-troubleshooting`.
