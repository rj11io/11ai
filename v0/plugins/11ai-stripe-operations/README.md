...
| Skill | Use it for |
| --- | --- |
| [`11ai-stripe-cheatsheet`](./skills/11ai-stripe-cheatsheet/SKILL.md) | Looking up API calls, CLI commands, amounts in minor units, test cards, and event types |
| [`11ai-stripe-setup`](./skills/11ai-stripe-setup/SKILL.md) | Adding test keys, a pinned server client, the CLI, local webhook forwarding, and a first price |
| [`11ai-stripe-environment`](./skills/11ai-stripe-environment/SKILL.md) | Confirming the account and mode, the API version, webhook endpoints, and configured prices |
| [`11ai-stripe-customers`](./skills/11ai-stripe-customers/SKILL.md) | Creating and reconciling customers without duplicates, payment method defaults, and the billing portal |
| [`11ai-stripe-products-and-prices`](./skills/11ai-stripe-products-and-prices/SKILL.md) | Modelling plans, changing pricing safely, and grandfathering existing subscribers |
| [`11ai-stripe-checkout`](./skills/11ai-stripe-checkout/SKILL.md) | Building Checkout sessions and fulfilling in the webhook rather than the success page |
| [`11ai-stripe-subscriptions`](./skills/11ai-stripe-subscriptions/SKILL.md) | Upgrades, downgrades, proration, cancellation, failed payments, and mirroring status |
| [`11ai-stripe-payments`](./skills/11ai-stripe-payments/SKILL.md) | One-off charges, authentication steps, capture timing, refunds, and disputes |
| [`11ai-stripe-webhooks`](./skills/11ai-stripe-webhooks/SKILL.md) | Verifying against the raw body, idempotent handling, and replaying missed events |
| [`11ai-stripe-integrations`](./skills/11ai-stripe-integrations/SKILL.md) | The local billing mirror, one entitlement function, identity links, tax, and reconciliation |
| [`11ai-stripe-troubleshooting`](./skills/11ai-stripe-troubleshooting/SKILL.md) | Diagnosing mode confusion, signature failures, double charges, and access that does not match billing |
