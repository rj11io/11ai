---
name: 11ai-operator-jest-integrations
...
- Do not add `--forceExit` to make a container-backed suite terminate. An open handle is a teardown bug; hand it to `11ai-operator-jest-troubleshooting`.
