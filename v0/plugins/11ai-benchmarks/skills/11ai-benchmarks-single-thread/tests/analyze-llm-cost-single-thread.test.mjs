...
try {
  ...
  assert.ok(markdown.endsWith("_AI benchmarks and analysis by [11ai-benchmarks-single-thread](https://ai.rj11.io/skills/11ai-benchmarks-single-thread)._\n"))
  ...
  assert.match(html, /<h1>AI benchmarks and analysis: Single-Thread Report <span class="powered-by"><a href="https:\/\/ai\.rj11\.io\/skills\/11ai-benchmarks-single-thread" target="_blank" rel="noopener noreferrer">powered by 11ai-benchmarks-single-thread<\/a><\/span><\/h1>/)
