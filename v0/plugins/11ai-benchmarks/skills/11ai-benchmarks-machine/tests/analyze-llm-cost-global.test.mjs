...
try {
  ...
  assert.match(markdown, /\| Workspace \| Cost \| Input \| Cached \| Input cost \| Output \| Output cost \| Tokens \| Cost \/ 1M tokens \| Threads \| Cost \/ thread \| Active time \| Cost \/ active hour \| Wall time \| Cost \/ wall hour \| Output TPS \| Active time \/ response \| Measured Cowork sessions \| Sub-agent runs \| Priced \| Unpriced \|/)
