...
const fixtureRoot = mkdtempSync(join(tmpdir(), "11ai-benchmarks-project-"))
...
try {
  ...
  assert.ok(markdown.endsWith("_AI benchmarks and analysis by [11ai-benchmarks-project](https://ai.rj11.io/skills/11ai-benchmarks-project)._\n"))
  ...
  assert.match(html, /<a href="https:\/\/ai\.rj11\.io\/skills\/11ai-benchmarks-project" target="_blank" rel="noopener noreferrer">11ai-benchmarks-project<\/a>/)
  ...
  assert.match(unmatchedHtml, /<a href="https:\/\/ai\.rj11\.io\/skills\/11ai-benchmarks-pricing-update" target="_blank" rel="noopener noreferrer">11ai-benchmarks-pricing-update<\/a>/)
  ...
  const reportsRoot = join(resolvedThreadRoot, "11ai-benchmarks-project-reports")
  ...
  assert.match(basename(defaultReportDir), /^11ai-benchmarks-project-reports-\d{4}-\d{2}-\d{2}T/)
  ...
  assert.match(basename(defaultSummary.markdownReport), /^11ai-benchmarks-project-\d{4}-\d{2}-\d{2}T.*\.md$/)
