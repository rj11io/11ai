---
name: 11ai-clerk-troubleshooting
...
Hand off when the cause is elsewhere: `11ai-clerk-environment` for instance and wiring questions, `11ai-clerk-setup` if the provider or middleware is missing, `11ai-clerk-authentication` for flows and redirects, `11ai-clerk-sessions` for protection and permissions, `11ai-clerk-users` for records and metadata, `11ai-clerk-organizations` for tenant scoping, and `11ai-clerk-webhooks` for event delivery.
