...
Use `11ai-clerk-environment` for the full inspection. If a provider and middleware already exist, this is not a fresh setup — change only what is missing.
