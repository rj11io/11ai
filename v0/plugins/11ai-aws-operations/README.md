...
| [`11ai-aws-ecs`](./skills/11ai-aws-ecs/SKILL.md) | Inspecting clusters, services, tasks, deployments, and ECS execution behavior |
| [`11ai-aws-ecr`](./skills/11ai-aws-ecr/SKILL.md) | Inspecting repositories and images, authenticating Docker, and managing image tags |
| [`11ai-aws-cloudwatch`](./skills/11ai-aws-cloudwatch/SKILL.md) | Querying logs, metrics, alarms, dashboards, and operational time windows |
| [`11ai-aws-iam`](./skills/11ai-aws-iam/SKILL.md) | Inspecting users, roles, policies, permission boundaries, and simulated access |
| [`11ai-aws-cloudformation`](./skills/11ai-aws-cloudformation/SKILL.md) | Validating templates and inspecting stacks, events, resources, and change sets |
| [`11ai-aws-cheatsheet`](./skills/11ai-aws-cheatsheet/SKILL.md) | Answering quick AWS CLI command, flag, output, and safety questions |
| [`11ai-aws-troubleshooting`](./skills/11ai-aws-troubleshooting/SKILL.md) | Diagnosing AWS CLI and service failures from reproducible evidence |
