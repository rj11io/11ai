---
name: 11ai-operator-nodejs-api-server
...
End with: command used, working directory, PID if applicable, port/address, readiness result, relevant logs or error, and whether the process remains running. If startup failed, hand the evidence to `11ai-operator-nodejs-api-troubleshooting`.
