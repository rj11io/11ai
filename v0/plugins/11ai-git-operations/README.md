...
| [`11ai-git-recovery`](./skills/11ai-git-recovery/SKILL.md) | Undoing local changes, reverting commits, and recovering reachable history with an explicit risk boundary |
| [`11ai-git-cheatsheet`](./skills/11ai-git-cheatsheet/SKILL.md) | Answering quick Git command, flag, and “what should I use?” questions with a compact safety-aware reference |
| [`11ai-git-troubleshooting`](./skills/11ai-git-troubleshooting/SKILL.md) | Diagnosing Git failures from read-only evidence before proposing the smallest justified repair |
